...
//crear un archivo Json para guardar información: ID del cliente, Token y Keys del cliente y del SERVER.
        fs.existsSync('./kittys.json') && client.loadAuthInfo('./kittys.json')
...
//La conexión fue en éxito querida
        client.on('open', () => {
        console.log('Conectado exitosamente :D')
        })
        await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./kittys.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
